...
var bcfirstimplantcalibration4 = new broadcastObj("Implant Calibration 1 Part 4", "activities/bcfirstimplantcalibration4", 2, "30000", "tal");
var bcsecondimplantcalibration1 = new broadcastObj("SECOND Match Implant Calibration", "activities/bcsecondimplantcalibration1", 2, "0", "tal");
var bcsecondimplantcalibration2 = new broadcastObj("Implant Calibration 2 Part 2", "activities/bcsecondimplantcalibration2", 2, "0", "tal");
var bcsecondimplantcalibration3 = new broadcastObj("Implant Calibration 2 Part 3", "activities/bcsecondimplantcalibration3", 2, "0", "tal");
var bcsecondimplantcalibration4 = new broadcastObj("Implant Calibration 2 Part 4", "activities/bcsecondimplantcalibration4", 2, "0", "tal");
var bcsecondimplantcalibrationFinal = new broadcastObj("Implant Calibration 2 Complete", "activities/bcsecondimplantcalibrationFinal", 2, "0", "tal");
var bcsupportgroups = new broadcastObj("Support Group Assignment", "activities/bcsupportgroups", 2, "0", "tal");
var bcfirstmatches = new broadcastObj("Announcing First Matches", "activities/bcfirstmatches", 2, "0", "tal");
var bcdinnerdate1 = new broadcastObj("Dinner Date & Free Time", "activities/bcdinnerdate1", 2, "0", "tal");
var bcsexed = new broadcastObj("Sexual Education Class (Optional)", "activities/bcsexed", 2, "0", "tal");
var bctangoclass = new broadcastObj("Tango Connection Class (Optional)", "activities/bctangoclass", 2, "0", "tal");
var bcrelationshipend1 = new broadcastObj("First Relationships End", "activities/bcrelationshipend1", 2, "0", "tal");
var bcsecondmatches = new broadcastObj("Second Matches Announced", "activities/bcsecondmatches", 2, "0", "tal");
var bcrelationshipbegin2 = new broadcastObj("Second Relationships Begin", "activities/bcrelationshipbegin2", 2, "0", "tal");
var bcjugglingclass = new broadcastObj("Duo Juggling Class (Optional)", "activities/bcjugglingclass", 2, "0", "tal");
var bcparentingclass = new broadcastObj("Parenting Class (Optional)", "activities/bcparentingclass", 2, "0", "tal");
var bcmeetfamily1 = new broadcastObj("Meet the Family Lunch 1", "activities/bcmeetfamily1", 2, "0", "tal");
var bcsoundtherapy = new broadcastObj("Couples Sound Therapy (Optional)", "activities/bcsoundtherapy", 2, "0", "tal");
var bcballroomclass = new broadcastObj("Ballroom Dancing Class (Optional)", "activities/bcballroomclass", 2, "0", "tal");
var bcdinnerdate2 = new broadcastObj("Final Dinner Date (2nd)", "activities/bcdinnerdate2", 2, "0", "tal");
var bcsinglesparty = new broadcastObj("Support Groups & Singles Party", "activities/bcsinglesparty", 2, "0", "tal");
var bcrelationshipbegin3 = new broadcastObj("Third Relationships Begin", "activities/bcrelationshipbegin3", 2, "0", "tal");
var bckaraoke = new broadcastObj("Karaoke! (Optional)", "activities/bckaraoke", 2, "0", "tal");
var bcbreakfast3 = new broadcastObj("Breakfast (3rd)", "activities/bcbreakfast3", 2, "0", "tal");
var bcsensualworkshop = new broadcastObj("Sensual Exploration Workshop (Optional)", "activities/bcsensualworkshop", 1, "0", "tal");
var bcartclass = new broadcastObj("Art Class (Optional)", "activities/bcartclass", 2, "0", "tal");
var bcmeetfamily2 = new broadcastObj("Meet the Family Lunch 2", "activities/bcmeetfamily2", 2, "0", "tal");
var bcrelationshipend3 = new broadcastObj("Third Relationship Ends", "activities/bcrelationshipend3", 2, "0", "tal");
var bcforevermatch = new broadcastObj("Forever Matches Announced", "activities/bcforevermatch", 2, "0", "tal");

/* Activity Warnings */
var bcrelationshipend1_20m = new broadcastObj("First Match Implant Calibration Forms", "activities/bcrelationshipend1_20m", 2, "0", "tal");
var bcrelationshipend1_15m = new broadcastObj("First Match End (15m Warning)", "activities/bcrelationshipend1_15m", 2, "0", "tal");
var bcrelationshipbegin2_10m = new broadcastObj("2nd Rel. Matches being computed", "activities/bcrelationshipbegin2_10m", 2, "0", "tal");
var bcrelationshipbegin2_5m = new broadcastObj("First Matches 2nd Rel.", "activities/bcrelationshipbegin2_5m", 2, "0", "tal");
var bcmeetfamily1_10m = new broadcastObj("Meet Family 1 (10m Warning)", "activities/bcmeetfamily1_10m", 2, "0", "tal");
var bcmeetfamily1_5m = new broadcastObj("Meet Family 1 (5m Warning)", "activities/bcmeetfamily1_5m", 2, "0", "tal");
var bcdinnerdate2_10m = new broadcastObj("Final Dinner 2 (10m Warning)", "activities/bcdinnerdate2_10m", 2, "0", "tal");
var bcdinnerdate2_5m = new broadcastObj("Final Dinner 2 (5m Warning)", "activities/bcdinnerdate2_5m", 2, "0", "tal");
var bcsinglesparty_10m = new broadcastObj("Singles Party (10m Warning)", "activities/bcsinglesparty_10m", 2, "0", "tal");
var bcsinglesparty_5m = new broadcastObj("Singles Party (5m Warning)", "activities/bcsinglesparty_5m", 2, "0", "tal");
var bcrelationshipbegin3_10m = new broadcastObj("Third Begin (10m Warning)", "activities/bcrelationshipbegin3_10m", 2, "0", "tal");
var bcrelationshipbegin3_5m = new broadcastObj("Third Begin (5m Warning)", "activities/bcrelationshipbegin3_5m", 2, "0", "tal");
var bcmeetfamily2_10m = new broadcastObj("Meet Family 2 (10m Warning)", "activities/bcmeetfamily2_10m", 2, "0", "tal");
var bcmeetfamily2_5m = new broadcastObj("Meet Family 2 (5m Warning)", "activities/bcmeetfamily2_5m", 2, "0", "tal");
var bcrelationshipend3_10m = new broadcastObj("Third End (10m Warning)", "activities/bcrelationshipend3_10m", 2, "0", "tal");
var bcrelationshipend3_5m = new broadcastObj("Third End (5m Warning)", "activities/bcrelationshipend3_5m", 2, "0", "tal");
var bcforevermatch_10m = new broadcastObj("Forever Match (10m Warning)", "activities/bcforevermatch_10m", 2, "0", "tal");
